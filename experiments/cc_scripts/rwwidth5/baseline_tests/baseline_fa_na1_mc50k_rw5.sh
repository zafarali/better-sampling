...
RW_TIME=50
RW_WIDTH=5
OUTFOLDER="./baseline_experiments/baseline_fa_na1_mc50k_rw5"
REWARDCLIP=-10
...
-rewardclip $REWARDCLIP -baseline fn_approximation -baseline_nn 2 2 2 -baseline_lr 1e-5 -nagents $N_AGENTS &
